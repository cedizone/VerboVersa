...
class SpeechActivity2 : AppCompatActivity(), TextToSpeech.OnInitListener, TabLayout.OnTabSelectedListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_speech) // Make sure to use your actual layout file name here
        ...
        val talkButton = findViewById<Button>(R.id.talk)
        ...
        tts = TextToSpeech(this@SpeechActivity2, this@SpeechActivity2 as TextToSpeech.OnInitListener)
    ...
    // Other functions including onTabSelected, onInit for TTS, etc.
